		...
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="./ManageRestaurant" title="" itemprop="url">餐廳管理</a></li>
			...
			<div class="card">
				...
				<div class="sec-box">
					<table class="table" style="font-size: 180%; color: #930000; text-align: center;">
						...
						<tr>
							<td>
								<a href="<c:url value='/seller/addmenu' />"> 
								<img src="../images/editfood_icon.png" style="width: 200px; height: 200vpx;"> 新增菜單
								</a>
							</td>
							<td>
								<a href="<c:url value='/seller/searchallmenu' />"> 
								<img src="../images/menu_icon.png" style="width: 200px; height: 200px;"> 查詢店裡所有菜單
								</a>
							</td>
						</tr>
						<tr>		
												...
												<div class="row">
													...
													<div class="col-md-3 col-sm-6 col-lg-3">
														<div class="widget information_links wow fadeIn"
															data-wow-delay="0.2s">
															<h4 class="widget-title" itemprop="headline">About
																Shop</h4>
															<ul>
														...
														<div class="widget get_in_touch wow fadeIn"
															...
															<ul>
																<li><i class="fa fa-envelope"></i> <a href="#"
																	title="" itemprop="url">hello@yourdomain.com</a></li>
															</ul>
														</div>
													</div>
												</div>
						...
						<div class="bottom-bar dark-bg text-center">
							<div class="container">
								<p itemprop="description">
									&copy; 2021 <a class="red-clr"
										href="http://www.bootstrapmb.com" title="Webinane"
										itemprop="url" target="_blank"></a>聚點食刻. All Rights Reserved
								</p>
							</div>
						</div>
