        ...
        <header class="stick">
            <div class="topbar">
                <div class="container">
                    ...
                    <div class="topbar-register"><a class="log-popup-btn" href="#" title="Login" itemprop="url">登入</a>/ <a class="sign-popup-btn" href="#" title="Register" itemprop="url">註冊</a></div>
...
<!--                                                     <a href="# " title="Home " itemprop="url "><img src="../../assets/images/logo.png " alt="logo.png " itemprop="image "></a> -->
                                                    <a href="<c:url value='/'/>" title="Home " itemprop="url "><img src="<c:url value='/assets/images/logo.png'/>" alt="logo.png " itemprop="image "></a>
                                                </h1>
                                            </div>
