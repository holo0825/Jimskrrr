...
<body itemscope>
	...
	<form:form action="./addtomenu" method='POST'
		...
		<fieldset>
			...
			<div class="st1">
				<label for="productName" class="t1">* 品名：</label> <input type="text"
					id="productName" name="productName" value="" size="20"> <span
					id="pronamesp"></span> <span class="ps">(必填！)</span>
				<form:errors path="productName" cssClass="error" />
			</div>

			<div class="st1">
				<label class="t1">照片:</label> <input type="file" accept="image/*"
					value="" id="dishImage" name="dishImage">
			</div>

			<div class="st1">
				<label for="remark" class="t1">菜色描述： </label>
				<textarea name="remark" id="remark" cols="40" rows="5"></textarea>
			</div>

			<div class="st1">
				<span id="pricesp">$NTD</span> <label for="price" class="t1">*單價：
				</label> <input type="text" id="price" name="price" value=""> <span
					id="prisp">(必填！)</span>
