...
<!--                                     <a href="# " title="HOMEPAGES " itemprop="url "> -->
                                    <a href="<c:url value='/'/>" title="HOMEPAGES " itemprop="url ">
                                ...
                                <!-- <div class="row"> -->
                                    ...
                                    <div class="col-md-6 col-sm-12 col-lg-6 ">
                                        <div class="sign-popup-wrapper brd-rd5 ">
                                            ...
                                            <!--form標籤開始-->
                                            <form:form id="registerForm" action="/register/process_seller" method="POST" modelAttribute="sellerRegisterBean" enctype='multipart/form-data'>
                                                <div class="sign-form ">
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 " >
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                                <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="phoneNumber" name="phoneNumber" placeholder="手機號碼 ex. 09XXXXXXXX" required="required"/>
                                                            </div>
                                            ...
                                            <div class="sign-popup-inner brd-rd5 ">
                                                ...
                                                <div class="sign-form ">  
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="telephoneNumber" name="telephoneNumber" placeholder="公司電話 ex. 02XXXXXXXX" />
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                                            <input class="brd-rd3 " style="font-size: 15px; margin-bottom: 5px;" type="text" id="extensionNumber" name="extensionNumber" placeholder="分機號碼 ex. #1234" />
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                                ...
                                <div class="row ">
                                    <div class="col-md-3 col-sm-6 col-lg-3 ">
                                        <div class="widget about_widget wow fadeIn " data-wow-delay="0.1s ">
                                            ...
                                            <div class="social2 ">
                                                <a class="brd-rd50 " href="# " title="Facebook " itemprop="url " target="_blank ">
                                                    <i class="fa fa-facebook "></i>
                                                </a>
                                                <a class="brd-rd50 " href="# " title="Google Plus " itemprop="url" target="_blank ">
                                                    <i class="fa fa-google-plus "></i>
                                                </a>
                                                <a class="brd-rd50 " href="# " title="Twitter " itemprop="url " target="_blank ">
                                                    <i class="fa fa-twitter "></i>
                                                </a>
                                                <a class="brd-rd50 " href="# " title="Pinterest " itemprop="url " target="_blank ">
