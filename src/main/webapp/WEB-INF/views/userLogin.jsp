...
// 	    out.println("window.location.href='index.jsp';");
	...
	if(session.getAttribute("user") != null) {
	    ...
	    //out.println("window.location.href='sellerCenter.jsp';");
	   	out.println("window.location.href='./UserHome");
	    out.println("</script>");
	}
	%>
	<h1>聚點時刻 買家用戶登入</h1>
...
<!-- 	<a href="index.jsp">首頁</a> -->
	...
	<div style="text-align: center">
		<h1>買家登入</h1>
<%-- 	<form:form method="POST" action=".\Userlogin" modelAttribute="userLoginBean"> --%>
		<!-- 
		<form:form method="GET" action=".\Userlogin" modelAttribute="userLoginBean">
         <table>
            <tr>
       ...
       -->
		<!-- Spring新版form:form表單 -->
		<form:form id="loginForm" method="GET" action=".\Userlogin" modelAttribute="userLoginBean">
