package com.GroupOne.Albert.recaptcha.service;

import com.GroupOne.Albert.recaptcha.responsemodel.CaptchaResponse;
...
// Validator calss to validate the captcha response coming from the client-side
//lombok annotation
@Slf4j
...
public class ValidateCaptcha {
    ...
    public boolean validateCaptcha(final String captchaResponse) {
        ...
        // checks if apiResponse is not null and if the apiResponse was successful
