...
//import com.GroupOne.Albert.email.EmailSender;
//
...
//		// if email is not valid, throw exception message
//		if (!isValidEmail) {
...
//				)
//		);
//		//  format URL with token, link for account activation
...
//        memberService.enableAppUser(
//                confirmationToken.getMember().getEmail());
//        return "confirmed";
//    }
//	
//	// constructs account activation email with given name and link
